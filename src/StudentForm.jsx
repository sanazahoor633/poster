...
const initialCourses = [
  ...
  { course: 'تم کب توبہ کرو گے', incharge: 'صالحہ', students: '10', start: '17 اکتوبر 2022', end: '', venue: 'برانچ' },
  { course: 'دسمبر کو رس', incharge: 'منیبہ محمود', students: '19', start: '10 جولائی 2023', end: '', venue: 'برانچ' },
  { course: 'بچوں کی تربیتvvvvvvvvvvvvvvvvvvvv', incharge: 'فوزیہ وحید', students: '12', start: '10 اکتوبر 2023', end: '', venue: 'رپور ویو' },
  ...
  { course: 'راہِ قرآن', incharge: 'منیبہ', students: '4', start: '15 مئی 2024', end: '', venue: 'برانچ' },
